...
便捷语聊是一款专为不能说话且不太方便打字的人群设计的语音辅助工具，帮助他们通过选择常用语句组成完整句子，并转换为语音播放，实现与他人的顺畅沟通。

## 功能特点

- **词组选择与句子组成**：从分类列表中选择常用词组，自动组成完整句子
- **文字转语音（TTS）**：支持将组成的句子转换为中文语音播放
- **词组分类管理**：根据使用场景和类型对词组进行分类，包括衣食住行、人际关系、行为动作等
- **历史记录**：保存用户最近使用的句子，支持快速调用
- **一键清空**：提供一键清空当前组成句子的功能
- **分享功能**：支持将组成的句子分享给他人
